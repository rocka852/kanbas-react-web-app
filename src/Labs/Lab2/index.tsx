...
{/*function doesn't have () and file must have ./*/}
export default function Lab2() {
	...
	<div className="container">
	  <div id = "wd-lab2">
	    ...
	    {/* after import index.css you can omit this 
	    <p style={{ backgroundColor: "Blue",
	                color: "white"}}> */}
	    {/*backgroundColor must be uppercase C
	       color must be lower case, which is foreground color
	       "white" "blue" is not case sensitive*/}
        {/* step II
        <p>
	    Style attribute allows configuring lli and feel 
	    ...
	    */}
	    ...
	    <div id="wd-css-class-selectors">
	        ...
	        Instead of using IDs to refer to elements, you can use an element's CLAS attribute
	        </p>
	    ...
	    {/*className is case sensitive
	      if you input wrong value of calssName, it will loss the style*/}
	    	...
	    	<div className="wd-selector-1">
	    		...
	    		<div className="wd-selector-2">
	    			...
	    			<p className="wd-selector-3">
	    				...
	    				You can combine these relationships to create specific styles depending on the documnet structure
	    		 	</p>
	  ...
	  {/*boarders margins and padding*/}
	  <div>	  
	  	<div id="wd-cs-borders">
	  		<h2>Borders</h2>
	  	...
	  	{/*floating is about horizontally display images and ractangles*/}
    ...
    <br /><br /><br />
  	...
  	{/*wide browser show four columns and small browser show 2 * 2 or 1*4*/}
  	...
  	{/*TABLE Bootstrap------------------------------------------------------*/}
		  ...
		  <table className="table">
		    ...
		    <tbody>
		      ...
		      <tr className="table-danger"> {/*this is color*/}
		      	<td>Q3</td>
		      	<td>		JavaScript</td>
		      	<td>2/17/21</td>
		      	<td>90</td>
	...
	{/*scroll bar*/}
	  ...
	  <div className="table-responsive"> {/*scrollbar part*/}
	    <table className="table">
	      <thead>
	...
	{/*bootstrap list*/}
	  ...
	  <ul className="list-group"> {/*bootstrap part*/}
	...
	{/*bootstrp switches from-check from-switch*/}
	...
	{/*Navigation with tabs nav nav-tabs makes horizontally*/}
